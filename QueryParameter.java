...
public class QueryParameter 
{
	...
	//This class should contains only properties and setter/getter methods only.
	public QueryParameter parseQuery(String queryString)
	{
		String baseQuery=null,conditionQuery=null,selectcol=null;
		//change this logic and move to QueryProcessor class
...
//change this logic
	...
	//QueryParser should only parse the query
	//not reading file
